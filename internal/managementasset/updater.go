...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/xiaotianwm/Cli-Proxy-API-Management-Center/releases/latest"
	defaultManagementFallbackURL = "https://github.com/xiaotianwm/Cli-Proxy-API-Management-Center/releases/latest/download/management.html"
